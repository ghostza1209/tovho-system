<section id="vision" class="pt-custom-breakpoint pb-custom-breakpoint" data-section-name="vision">
        ...
        <div class="col-12 col-md-7 m-auto">
            ...
            <div class="row mt-5">
                <p class="text-center px-5">
                    ...
                    前へ前へと進む意味を込め、後ろへ下がることなく、前進する会社でありたい。
                    日本の未来を飛躍させる、そして世界で活躍する人々を応援する、そんな仕事ができればと考えています。
                </p>
            </div>
            <div class="row mt-5">
                <blockquote class="text-center text-in-box mr-auto ml-auto w-100">
                    <p class="mb-0">Tovho System is looking at three years future, five years future in the field of view,
                        it will lead today to tomorrow.<br/>
                        Company name is a Tovho is derived from the ancient name of the dragonfly.<br/>
                        In dragonfly is called wins insects good luck and From where you do not retreat does not proceed
                        only in front,<br/>
